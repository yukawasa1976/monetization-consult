  ...
  return (
    <div className="flex h-dvh flex-col bg-zinc-50">
      ...
      {!session?.user && messages.length > 0 && !isLoading && (
        <div className="border-t border-zinc-100 bg-amber-50 px-4 py-4">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-3 text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl border border-amber-300 bg-white px-6 py-3 text-sm font-medium text-amber-800 shadow-sm transition-colors hover:bg-amber-50"
            >
              {conversationCopied ? (
                <>
